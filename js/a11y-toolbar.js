    ...
    return {
        ...
        buildToolbar: function() {
            var toolbar = [
                ...
                '<div class="a11y-toolbar" role="region" aria-label="Akadálymentes változat">',
                    '<ul>',
                        '<li>',
                            '<button type="button" class="a11y-control" data-a11y="' + _contrast + '" aria-pressed="false" title="Nagy kontrasztú verzió ki/be">',
                                '<span class="a11y-icon icon-contrast" aria-hidden="true"></span>',
                            '</button>',
                        '</li>',
                        '<li>',
                            '<button type="button" class="a11y-control" data-a11y="' + _desaturate + '" aria-pressed="false" title="Szürkeárnyalatos verzió ki/be">',
